...
**To view dashboards:** SSH into the server and run `docker compose up -d grafana`, then visit `http://51.21.45.93:3000`. Since Prometheus runs continuously, historical metrics are available immediately once Grafana starts.
